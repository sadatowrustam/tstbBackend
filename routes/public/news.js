...
const {getMain,addTags,addNews,editNews,newsByTag,deleteTag,deleteNews,getOneNews,loadMore,getAll,getTags,addPicture,isActiveNews}=require("../../contollers/newsController")
